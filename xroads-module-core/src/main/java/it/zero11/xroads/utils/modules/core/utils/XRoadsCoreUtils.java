...
public class XRoadsCoreUtils {
	...
	public static boolean productHasChanged(Product p1, Product p2) {
		return changedMethods(p1, p2, Product::getBrand, Product::getCost, Product::getData, Product::getDescriptions, Product::getEan, 
				...
				Product::getVirtual, Product::getOnline, Product::getRestrictions, Product::getUrlkeys, Product::getHiddenFromCatalog);
	}
	...
	public static boolean priceHasChanged(Price p1, Price p2) {
		return changedMethods(p1, p2, Price::getBuyPrice, Price::getCountry, Price::getCustomerSourceId, Price::getData,
				Price::getDiscountedPrice, Price::getListingGroup, Price::getMinQuantity, Price::getProductSourceId,
				Price::getRetailPrice, Price::getSellPrice, Price::getSuggestedPrice, Price::getMerchantCode);
	}
	...
	public static boolean customerHasChanged(Customer p1, Customer p2){
		return changedMethods(p1, p2, Customer::getAddresses, Customer::getCompany, Customer::getData, Customer::getDateOfBirth, Customer::getEmail, 
				...
				Customer::getSourceId, Customer::getUsername, Customer::getVatNumber, Customer::getPaymentTerms, Customer::getTradeAgent);		
	}
